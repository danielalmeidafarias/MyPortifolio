    ...
    <div className='flex flex-col items-center gap-10'>
        ...
        <div className='flex flex-col items-center gap-5'>
            <div className='flex flex-col items-center'>
                ...
                <a href="https://harmonious-stardust-0e6b10.netlify.app/" rel="noreferrer" target="_blank"><img className="w-64 sm:w-96 rounded-lg shadow-lg shadow-zinc-500 mb-2" src={ToDoList} alt=""  /></a>
