        ...
        <section className="flex flex-col items-center gap-7 mb-10">
            ...
            <div className="flex flex-col items-center sm:flex-row sm:gap-10">
                <div className="flex flex-col p-2 items-center">
                    ...
                    <p className="text-xl font-light">• Daniel de Almeida Farias</p>
                    <p className="text-xl font-light">• São José dos Campos-SP</p>
                </div>
                <div className="p-2 sm:w-80">
                    <p className="text-xl font-light text-center">Tenho 20 anos, sou um jovem curioso e que adora desafios, eles me movimentam. Estou em busca de minha primeira oportunidade na área da tecnologia. Quero aprender muito e criar uma carreira promissora junto de uma equipe de Desenvolvimento.</p>
                </div>
            </div>

            <div className="flex flex-col items-center text-2xl font-semibold text-center gap-4">
                <h3 className="text-xl mb-5">Tecnologias que estou estudando</h3>
