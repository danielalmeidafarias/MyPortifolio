...
const HamburgerMenu = () => {
    ...
    return ( 
        <div>
            ...
            <div className="hamburger md:hidden flex flex-col gap-1" onClick={ToggleMode}>
            ...
            <div className={active ? 'block absolute top-16.5 right-10 bg-black w-56 h-12 p-2 ease-in-out   duration-200 rounded-bl rounded-br mt-3 md:hidden' : ' block absolute top-16 right-10 duration-100 ease-in-out -w-24 -h-28 md:hidden'}>
